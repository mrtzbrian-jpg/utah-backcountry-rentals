...
window.DATA = (function () {
  ...
  const gear = [
    ...
    },
    {
      ...
      category: "Bundles",
      tagline: "4 matching packs, one big tent, shared gear — smart not heavy",
      desc: "Four matching 50L packs (one per person), plus the 10-person Ozark Trail cabin tent with 3 rooms and full standing height. Sleep systems for all four, one shared water filter, one stove, and two cookpots so you can boil water and cook at the same time. No doubling up on gear the family shares — just what you need.",
      price: 199,
      unit: "weekend",
      weight: 62,
      ...
      deposit: 550,
      bundleItems: [
        { id: "budget-pack-50l",      qty: 4 },
        { id: "cabin-tent-10p",       qty: 1 },
        { id: "ozark-sleeping-bag",   qty: 4 },
        { id: "foam-sleep-pad",       qty: 4 },
        { id: "sawyer-squeeze",       qty: 1 },
        { id: "headlamp-200l",        qty: 4 },
        { id: "brs-stove-kit",        qty: 1 },
        { id: "titanium-cookpot",     qty: 2 },
        { id: "trail-essentials",     qty: 1 }
      ],
      includes: [
        "4× Budget 50L Hiking Packs — one per person, all matching",
        "10-Person Ozark Trail Cabin Tent — 3 rooms, full standing height",
        "4× 30°F Mummy Sleeping Bags",
        "4× Foam Sleeping Pads",
        "Sawyer Squeeze Water Filter — one filter handles the whole family",
        "4× 200-Lumen Headlamps",
        "BRS-3000T Stove + isobutane fuel + lighter",
        "2× Titanium Cookpots — boil water and cook simultaneously",
        "Trail Safety Kit: first aid, space blanket, knife, whistle, trowel, LNT waste bags"
      ]
    },
    ...
    {
      id: "cabin-tent-10p",
      name: "10-Person Family Cabin Tent",
      category: "Shelter",
      tagline: "Stand-up room for the whole crew — 3 rooms, fits 4 air mattresses",
      desc: "Ozark Trail 10-person 3-room cabin tent. Full standing height, divides into 3 separate rooms or opens as one big space. Front awning, gear loft, and E-port for power cords. Built for drive-in campsite comfort — pairs perfectly with the Family Bundle.",
      price: 25,
      unit: "weekend",
      perDay: 10,
      weight: 28,
      ...
      includes: [
        ...
        "3 removable room dividers",
        "Front awning porch",
        "Stakes, guylines, and carry bag"
      ]
    },
    {
