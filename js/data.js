...
window.DATA = (function () {
  ...
  const gear = [
    /* ---- PRE-BUILT BUNDLES ---- */
    {
      ...
      category: "Bundles",
      tagline: "Everything for a solo weekend — budget gear, real adventure",
      desc: "Our most popular starter kit. A full-size pack, shelter, warm sleep system, water filtration, and bear canister — everything you need, nothing you don't. Budget-sourced and packed and ready at pickup.",
      price: 79,
      unit: "weekend",
      weight: 14.1,
      icon: "backpack",
    ...
    },
    {
      ...
      category: "Bundles",
      tagline: "Two-person kit — share the weight, share the views, skip the price tag",
      desc: "Built for two, priced to not hurt. Two full-size packs, a two-person tent, two sleep systems, water filter, bear canister, and satellite communicator. Everything you need from trailhead to camp and back.",
      price: 145,
      unit: "weekend",
      weight: 28.4,
      icon: "people",
    ...
    },
    {
      ...
      name: "Family Weekend",
      category: "Bundles",
      tagline: "The whole family outdoors — without the whole paycheck",
      desc: "Take the whole family off-grid without breaking the bank. Built for 2 adults + 2 kids: packs for everyone, two tents, four sleeping bags, dual water filtration, bear canister, and satellite safety. The full family setup at a budget price.",
      price: 195,
      unit: "weekend",
      weight: 45.0,
